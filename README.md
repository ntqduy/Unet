...
```bash
python train_pgd.py --dataset cvc --root_path data/CVC-ClinicDB --teacher_model unet_resnet152 --encoder_pretrained 1 --max_epochs_teacher 50 --max_epochs_student 100 --prune_ratio 0.5
```
