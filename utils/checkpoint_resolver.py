...
def extract_checkpoint_signature(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "vnet_normalization": config.get("vnet_normalization", architecture_config.get("normalization")),
        "vnet_has_dropout": config.get("vnet_has_dropout", architecture_config.get("has_dropout")),
        "vnet_has_residual": config.get("vnet_has_residual", architecture_config.get("has_residual")),
...
def build_expected_signature(
    *,
    ...
    vnet_normalization: Optional[str] = None,
    vnet_has_dropout: Optional[int | bool] = None,
    vnet_has_residual: Optional[int | bool] = None,
    ...
    return {
        ...
        "vnet_normalization": vnet_normalization,
        "vnet_has_dropout": vnet_has_dropout,
        "vnet_has_residual": vnet_has_residual,
        "teacher_model": teacher_model,
