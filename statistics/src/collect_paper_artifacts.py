...
MAIN_FIGURES = [
    ...
    ("figure3_blueprint", "{dataset}/figure3_blueprint_importance_thresholds.pdf"),
    ("figure3_middle_conv2", "{dataset}/figure3_middle_conv2_importance_thresholds.pdf"),
    ("figure3_full_block", "{dataset}/figure3_full_block_output_importance_thresholds.pdf"),
    ("figure3_full_block_conv1", "{dataset}/figure3_full_block_conv1_importance_thresholds.pdf"),
    ("figure3_full_block_conv2", "{dataset}/figure3_full_block_conv2_importance_thresholds.pdf"),
    ("figure4", "paper_figures/figure4_block_pruning_strategy.pdf"),
    ("figure5", "{dataset}/figure5_layerwise_pruning_ratio.pdf"),
    ("figure5_blueprint", "{dataset}/figure5_blueprint_stage_pruning_ratio.pdf"),
    ("figure5_middle_conv2", "{dataset}/figure5_middle_conv2_layerwise_pruning_ratio.pdf"),
    ("figure5_full_block", "{dataset}/figure5_full_block_layerwise_pruning_ratio.pdf"),
    ("figure5_full_block_conv1", "{dataset}/figure5_full_block_conv1_pruning_ratio.pdf"),
    ("figure5_full_block_conv2", "{dataset}/figure5_full_block_conv2_pruning_ratio.pdf"),
    ("figure5_full_block_conv3", "{dataset}/figure5_full_block_conv3_pruning_ratio.pdf"),
    ...
    ("figure23", "{dataset}/figure23_threshold_selection_methods.pdf"),
]
